...
<body>
    <div  class="navbar-fixed z-depth-3">
        <nav class="white lighten-5 hoverable navbar-fixed">
            ...
            <a href="#!" style="margin-left: 25px;" id="myToggler" class="left brand-logo grey-text lighten-2"><i class="material-icons">menu</i> Stats</a>
    ...
    <div class="container">
        <ul id="slide-out" class="sidenav light-blue darken-1">
            ...
            <li><a class="mb-5" href="http://developer.al-masi.com/views/mytodo.php" id="liHover"><i class="material-icons">vpn_lock</i> Blog</a></li>
