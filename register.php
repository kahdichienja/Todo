  ...
  <ul class="sidenav light-blue darken-1" id="mobile-demo">
    ...
    <div class="container">
        <div class="col s12 m7">
            <h2 class="header black-text">Register</h2>
                ...
                <div class="card-stacked white blue-grey lighten-5">
                    ...
                    <div class="card-action">
                        <a href="login.php" class="waves-effect waves-light btn red"><i class="fab fa-google-plus-g fa-10x"></i> Sign Up with google</a>
                    </div>
                </div>
            </div>
        </div>        
